...
def main():
    ...
    parser.add_argument("-a", "--area_info",
                        help="Dictionary with area information")
    parser.add_argument("-c", "--chapter_info",
                        help="Dictionary with chapter information")
    parser.add_argument("-s", "--selected_cases", type=str, default=None,
    ...
    for fl in os.listdir(args.input_path):
        ...
        act_sec = get_area_act_chapter_section_info(secs, area_info,
                                                    chapter_info)
    ...
    with open(os.path.join(args.output_path, "area_case_info.json"),
              'w') as f:
    ...
    with open(os.path.join(args.output_path, "area_case_num.json"),
              'w') as f:
