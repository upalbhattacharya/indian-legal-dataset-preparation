...
# -*- coding: utf-8 -*-
# Birth: 2022-08-29 23:38:46.051331179 +0530
# Modify: 2022-09-06 20:02:30.505239817 +0530
...
def main():
    ...
    parser.add_argument("-a", "--case_advs",
                        help="Path to advocates for cases (for clean up)")
    ...
    for fl in os.listdir(args.input_path):
        ...
        if case_advs.get(flname, -1) == -1:
            logging.info(f"No targets found for masking for {fl}")
            targets = []
        else:
            targets = case_advs[flname]
