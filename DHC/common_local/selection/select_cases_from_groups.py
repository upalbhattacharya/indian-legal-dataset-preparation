...
def main():
    ...
    for case, info in case_info.items():
        ...
        rel_sections = [sec
                        for sec in sections if sec.split("_")[0] in rel_acts
                        or sec in targets_dict["sections"]]
        rel_chapters = [section_chapters[sec] for sec in rel_sections]
