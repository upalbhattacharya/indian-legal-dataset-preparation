...
# Modify: 2022-02-21 11:31:28.131185622 +0530
...
def main():
    ...
    set_logger(os.path.join(args.input_path, "combine_roles.log"))
    ...
    for filename in os.listdir(args.input_path):
        ...
        if (len(list(json_obj.keys())) == len(roles)):
            for sent_idx, role in zip(json, roles):
                json[sent_idx]["Facts"] = role
