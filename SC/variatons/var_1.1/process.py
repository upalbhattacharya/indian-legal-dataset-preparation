...
# Birth: 2022-02-28 11:55:29.391562689 +0530
# Modify: 2022-02-28 11:55:29.404896022 +0530
...
from mask import ner_mask, mask, patterns
...
def main():
    ...
    for fl in os.listdir(args.input_path):
        ...
        if (text is None):
            logging.info(f"No text found for {fl}. Skipping.")
            continue
