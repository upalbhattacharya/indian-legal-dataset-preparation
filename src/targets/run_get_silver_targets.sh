...
./get_silver_targets.py --data_targets ~/Datasets/DHC/variations/v5/targets/case_advs.json \
  --attribute_targets ~/Datasets/DHC/variations/v5/adv_info/overall/area_act_chapter_section_info/section_adv_info.json \
  ...
  --similarity 1.0 \
  --key "sections" \
  --omit_attribute ~/Datasets/DHC/variations/v5/area_act_chapter_section_info/sections_to_omit.txt \
